...
namespace ConsoleApp10
{
    class Mergesort
    {
        public Stopwatch tiempo = new Stopwatch();
        public void Cargar()
        {
            int[] nums = new int[40];
        ...
        static public void MergeSort(int[] x, int desde, int hasta)
        {
            //Condicion de parada
            if (desde == hasta)
                return;
        ...
        static public int[] Merge(int[] x, int desde1, int hasta1, int desde2, int hasta2)
        {
            int a = desde1;
            int b = desde2;
